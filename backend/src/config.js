...
const layerConfigurations = [
  {
    ...
    layersOrder: [
      ...
      { name: "4 Eyes" },
      { name: "3 Hats" },
      { name: "2 Assassination Style" },
      { name: "1 Sparkly Extras" },
      { name: "Logo" },
    ],
  },
  {
    ...
    layersOrder: [
      { name: "Background Lobster" },
      { name: "Lobster" },
      { name: "Lobster Hat" },
      { name: "Sparkly Extras Lobster" },
      { name: "Logo" },
    ],
  },
];
...
const extraMetadata = {
  external_url: "xcutnputin.com", // Replace with your website or remove this line if you do not have one.
};
...
const CONTRACT_NAME = 'XCUTNPutin';
const CONTRACT_SYMBOL = 'XCP';
const METADATA_UPDATABLE = true; // set to false if you don't want to allow metadata updates after minting
const OWNER_ADDRESS = '0x9D351A2A5e7C704f7730d7831EB4F061991ED560';
const TREASURY_ADDRESS = '0x9D351A2A5e7C704f7730d7831EB4F061991ED560';
...
const ROYALTY_ADDRESS = "0x9D351A2A5e7C704f7730d7831EB4F061991ED560"; // Address that will receive the royalty
